package com.catalog.demo.resources;
...
import com.catalog.demo.services.ProductService;
...
public class ProductResource {
	...
	@GetMapping
	public ResponseEntity<Page<ProductDTO>> findAll(@RequestParam(value = "pagina", defaultValue = "0") Integer pagina,
